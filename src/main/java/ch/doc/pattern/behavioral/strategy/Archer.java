 ...
 *
 */
public class Archer implements Unite {

	/* (non-Javadoc)
	 * @see ch.doc.pattern.behavioral.strategy.Unite#attaque(ch.doc.pattern.behavioral.strategy.Cible)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.doc.pattern.behavioral.strategy.Unite#avance(ch.doc.pattern.behavioral.strategy.Carte)
	 */
	@Override
